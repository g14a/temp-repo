...
check index_concurrent  "CREATE INDEX CONCURRENTLY idx_users_email ON users(email);" "HIGH"
check index_concurrent_ifne "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_pt ON processor_transaction (a, b) WHERE c != '';" "HIGH"
